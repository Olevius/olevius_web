...
export const teamMembers: TeamMember[] = [
  {
    name: "Levi Brunelle",
    role: "Mechanical Design and Optics",
    description: "Levi contributes to the mechanical design and optics aspects of the project, focusing on developing and testing the PDMS pouch and fluid interface that enables the fiber-optic sensor to detect blood pressure changes. His work ensures the sensor has the right mechanical properties to translate pulse-induced pressure variations into reliable optical signals, while also exploring alternative polymers and materials for durability and comfort in a wearable device.",
    imageSrc: new URL("../assets/team/levi.png", import.meta.url).href,
  },
  {
    name: "Matthew Athansopoulos",
    role: "Data Science and Optimization",
    description: "Matthew works on the data science and optimization side of the project, focusing on developing the machine learning model that translates raw optical waveforms into accurate blood pressure readings. He trains and refines algorithms using both collected and open-source medical datasets, while optimizing them for real-time analysis on wearable hardware. His efforts help ensure the device achieves clinically acceptable accuracy and scalability.",
    imageSrc: new URL("../assets/team/matthew.png", import.meta.url).href,
  },
  {
    name: "Andrew Hansraj",
    role: "Hardware Integration",
    description: "Andrew focuses on hardware integration, working on the mechanical design and electronics packaging that transform the prototype into a practical wearable form. He embeds the optical fibers, photodetector, and wireless modules into a compact watch-like device that is comfortable, robust, and power-efficient. His contributions help bridge the gap between lab-scale testing and a functional, user-ready product.",
    imageSrc: new URL("../assets/team/andrew.png", import.meta.url).href,
  },
  {
    name: "Justin Mak",
    role: "Frontend and App Development",
    description: "Justin contributes to the user interface and database systems that support the device’s functionality. He designs the companion mobile application that connects to the wearable via Bluetooth/NFC, enabling continuous monitoring and visualization of blood pressure trends. He also ensures that data storage and transmission meet requirements for usability and potential healthcare integration, creating a smooth link between the hardware sensor and its end users.",
